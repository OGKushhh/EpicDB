  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <header className="mb-8 text-center">
        <h1 className="text-3xl font-bold tracking-tight">Welcome to EpicDB</h1>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed text-[var(--color-text-muted)]">
          ...
          endpoint). It is <strong>not affiliated with Epic Games</strong> — this is a
          fan-built tool for browsing data that's otherwise scattered or hard to access.
        </p>
      </section>

      <section className="mb-8">
        <h2 className="mb-3 text-lg font-semibold">What can you do here?</h2>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <Link
            to={routes.manifests}
            className="card group transition-colors hover:border-[var(--color-accent)] hover:bg-[var(--color-accent)]/5"
          >
            <div className="text-2xl mb-2">📦</div>
            <h3 className="text-base font-semibold">Manifest Browser</h3>
            ...
            <span className="mt-3 inline-flex items-center gap-1 text-sm text-[var(--color-accent)] group-hover:underline">
              Browse manifests →
            </span>
          </Link>
          ...
          >
            <div className="text-2xl mb-2">🎮</div>
            <h3 className="text-base font-semibold">Game Browser</h3>
            <p className="mt-1 text-sm text-[var(--color-text-muted)]">
      ...
      <section className="mb-8">
        <h2 className="mb-2 text-lg font-semibold">Where does the data come from?</h2>
        <ul className="space-y-2 text-sm text-[var(--color-text-muted)]">
          <li>
            ...
            <code className="mono text-xs">effective_id</code> — the canonical lookup key
      ...
      <section className="text-xs text-[var(--color-text-muted)] border-t border-white/10 pt-4">
        Open-source on{" "}
        <a
